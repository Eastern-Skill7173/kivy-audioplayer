...
An audio player utility to be used in your kivy app. This project is an extension
of the base audio utilities provided by kivy, including features like:

* Loading multiple audio files and queuing them
* Registering and accessing files through aliases
* Using the operating system's player (as of now only Android is integrated)
* Fast-forwarding, rewinding and ...

## Getting Started

NOTE: THIS PROJECT IS BASED ON KIVY'S UTILITES AND CAN BE ONLY USED IN KIVY APPLICATIONS
